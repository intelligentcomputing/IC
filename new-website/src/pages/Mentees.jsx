...
export default function Mentees() {
  ...
  const rawMentees = getData('mentees', StaticData.SheejaMentees);
  
  // Filter for Sheeja's mentees specifically if using a combined sheet, 
  // or just use the sheet as is if it's the correct tab.
  // For simplicity, we assume the linked "mentees" sheet is the correct data for this page.
  const mentees = rawMentees;
      ...
      <div className="mentee-grid">
        {filteredMentees.map((m, i) => (
          <div className="mentee-card" key={i}>
            <img alt={m.name} src={m.img || m.image}/>
